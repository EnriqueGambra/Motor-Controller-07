...
epicsEnvSet("ENGINEER",  "“Kirkland” @“2258”")
epicsEnvSet("LOCATION",  "07ID A-hutch RGA:3")
epicsEnvSet("STREAM_PROTOCOL_PATH", ".:../protocols:$(PMACUTIL)/protocol:/$(PMACCOORD)/protocol")

epicsEnvSet("SYS",           "XF:07IDA-CT")
epicsEnvSet("IOC_ASYN",      "$(SYS){MC:07}")
epicsEnvSet("IOC_PREFIX",    "$(SYS){IOC:MC07}")
## epicsEnvSet("CONTROLLER_IP", "xf07id1-mc07")
epicsEnvSet("CONTROLLER_IP", "10.7.2.87")

epicsEnvSet("EPICS_CA_AUTO_ADDR_LIST", "NO")
epicsEnvSet("EPICS_CA_ADDR_LIST", "10.7.0.255")
...
# caPutLogInit("xf07id-ca1:7004", 1)
...
cd ${TOP}
dbl > ./records.dbl
#system "cp ./records.dbl /cf-update/xf07ida-ioc1.mc07.dbl"
