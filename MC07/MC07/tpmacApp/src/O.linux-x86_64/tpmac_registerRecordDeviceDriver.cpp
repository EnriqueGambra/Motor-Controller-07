...
static const char * const deviceSupportNames[114] = {
    "devAaiSoft",
    "devaaiStream",
    "devAaoSoft",
    "devaaoStream",
...
static const dset * const devsl[114] = {
...
{
    const char *bldTop = "/epics/iocs/MC07";
    ...
    registerDevices(pbase, 114, deviceSupportNames, devsl);
